...
public class SendMailSSL {
	public static synchronized void send(String mailHost, String from, String to, String cc, String bcc,
		    String subject, String body, String attachFile)   {
        ...
        //props.put("mail.smtp.localhost", propertyMap.get("host"));//unix box
	...
	public static synchronized void sendToEveryone(String mailHost, String from, String to, String cc, String bcc,
